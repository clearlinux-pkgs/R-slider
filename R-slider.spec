...
Version  : 0.1.5
Release  : 1
URL      : https://cran.r-project.org/src/contrib/slider_0.1.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/slider_0.1.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603292840
