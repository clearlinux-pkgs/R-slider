...
Version  : 0.3.2
Release  : 29
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/slider_0.3.2.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/slider_0.3.2.tar.gz
...
%setup -q -n slider
pushd ..
cp -a slider buildavx2
popd
pushd ..
cp -a slider buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731651255
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/slider/libs/slider.so
/V4/usr/lib64/R/library/slider/libs/slider.so
